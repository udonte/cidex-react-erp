    ...
    return (
      <>
        <div className=" w-full 10px">
          ...
          >
            <div
              className={`px-6 text-sm flex h-[44px] w-full justify-between items-center hover:bg-[#f89d685b]  hover:text-[#AF531F] font-semibold"
          ...
          <div
            className={`${
              showSubMenu
                ? "opacity-100 max-h-full border-b"
                : "opacity-0 max-h-0 invisible"
            }`}
            style={{
              transition:
                "opacity 0.3s ease-in-out, max-height 0.3s ease-in-out, visibilty 0.1s ease-in-out",
            }}
          >
