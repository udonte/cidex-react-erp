...
import MiddleModalContainer from "../../../../components/HRM_components/_common/MiddleModalContainer/MiddleModalContainer";
...
const ImportEmployees = () => {
  ...
  return (
    <MiddleModalContainer>
      <div className="bg-white px-8 py-4 w-[750px] h-[520px]">
