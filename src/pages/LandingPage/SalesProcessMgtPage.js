...
const SalesFirstSection = () => {
  return (
    <section className="bg-cyan-green py-8">
      <div className="text-center mx-auto">
        <h1 className="text-4xl font-bold text-gurugeeks_bold_color my-6 max-sm:text-3xl">
      ...
      <div className="my-16 flex gap-20 p-10 justify-between w-11/12 mx-auto max-md:flex-col max-md:gap-8">
        ...
        <div>
          <img
            src={analytics}
            alt="analytics"
            className="shadow-[0_35px_60px_-15px_rgba(136,180,204,1)] w-[1500px]"
          />
        </div>
      </div>
    </section>
...
export default SalesProcessMgtPage;
