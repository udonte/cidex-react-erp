    ...
    <>
                    ...
                    option.list.map((item, index) => (
                      <div key={index}>
                        <div
                          ...
                          className="h-10 px-2 capitalize z-150  flex items-center bg-white border hover:bg-slate-50 border-gray-300 shadow-lg"
                        >
                          {item.name}
                        </div>
                      </div>
      ...
      <div className="px-6 my-2 flex-wrap flex items-center gap-x-2">
        {selectedFilters?.map((item) => (
          <div className=" bg-orange-200 h-8 w-fit rounded flex items-center justify-center px-2 my-2">
            <p>
              {item.name}:{" "}
