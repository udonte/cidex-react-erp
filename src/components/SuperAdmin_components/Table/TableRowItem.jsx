...
import DotOptions from "../common/DotOptions";
...
const TableRowItem = ({
  ...
  return (
    <tr
      ...
      className=" px-6 text-center bg-white h-[60px] text-lg font-medium border-y-2 hover:bg-slate-50 cursor-pointer"
    >
      {checkbox && (
        <td>
          <div className="">
        ...
        >
          ...
          {showDropDown && (
            <div
              ...
              className="text-gray-600 absolute z-50 top-[50px]  w-fit  min-w-max right-[60px] top border rounded bg-white shadow-lg"
            >
